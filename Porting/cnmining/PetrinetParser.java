...
public class PetrinetParser
{
			...
			throws IOException, ParseException
	{
	    ...
	    HashMap<PetrinetNode, Node> hashmap = new HashMap<PetrinetNode, Node>();
	    int x;
	    while (it.hasNext())
	    {
	    	...
	    	if (!t.isInvisible())
	    	{
	    		...
	    		g.getMap().put(n, new ObjectOpenHashSet<Object>());
