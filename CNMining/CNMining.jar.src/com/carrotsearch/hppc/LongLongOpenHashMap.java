...
/*  213 */     for (LongLongCursor c : container)
/*      */     {
...
/*  228 */     for (LongLongCursor c : iterable)
/*      */     {
...
/*      */       }
/*  747 */       if ((obj instanceof LongLongMap))
/*      */       {
/*      */ 
/*  750 */         LongLongMap other = (LongLongMap)obj;
/*  751 */         if (other.size() == size())
/*      */         {
/*  753 */           for (LongLongCursor c : this)
/*      */           {
...
/*      */     {
/*  781 */       this.cursor = new LongLongCursor();
...
/*  789 */       int max = LongLongOpenHashMap.this.keys.length;
/*  790 */       while ((i < max) && (LongLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  792 */         i++;
/*      */       }
/*      */       
/*  795 */       if (i == max) {
/*  796 */         return (LongLongCursor)done();
/*      */       }
/*  798 */       this.cursor.index = i;
/*  799 */       this.cursor.key = LongLongOpenHashMap.this.keys[i];
/*  800 */       this.cursor.value = LongLongOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  849 */     private final LongLongOpenHashMap owner = LongLongOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(long e)
/*      */     {
/*  855 */       return LongLongOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  900 */       return new LongLongOpenHashMap.KeysIterator(LongLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*  952 */       int max = LongLongOpenHashMap.this.keys.length;
/*  953 */       while ((i < max) && (LongLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  955 */         i++;
/*      */       }
/*      */       
...
/*  962 */       this.cursor.value = LongLongOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  985 */       return LongLongOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  991 */       return LongLongOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  998 */       boolean[] allocated = LongLongOpenHashMap.this.allocated;
/*  999 */       long[] values = LongLongOpenHashMap.this.values;
/*      */       
...
/*      */     public <T extends LongProcedure> T forEach(T procedure)
/*      */     {
/* 1014 */       boolean[] allocated = LongLongOpenHashMap.this.allocated;
/* 1015 */       long[] values = LongLongOpenHashMap.this.values;
/*      */       
...
/*      */     public <T extends LongPredicate> T forEach(T predicate)
/*      */     {
/* 1029 */       boolean[] allocated = LongLongOpenHashMap.this.allocated;
/* 1030 */       long[] values = LongLongOpenHashMap.this.values;
/*      */       
...
/*      */     public Iterator<LongCursor> iterator()
/*      */     {
/* 1047 */       return new LongLongOpenHashMap.ValuesIterator(LongLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int removeAllOccurrences(long e)
...
/* 1086 */       int max = LongLongOpenHashMap.this.keys.length;
/* 1087 */       while ((i < max) && (LongLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1089 */         i++;
/*      */       }
/*      */       
...
/* 1096 */       this.cursor.value = LongLongOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1111 */       LongLongOpenHashMap cloned = (LongLongOpenHashMap)super.clone();
/*      */       
/*      */ 
...
/* 1136 */     for (LongLongCursor cursor : this)
/*      */     {
...
/*      */     }
/* 1156 */     LongLongOpenHashMap map = new LongLongOpenHashMap();
...
/*      */   {
/* 1169 */     return new LongLongOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1178 */     return new LongLongOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1200 */     return new LongLongOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/LongLongOpenHashMap.class
