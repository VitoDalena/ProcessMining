...
/*     */   
/*  97 */   public BitSetIterator(BitSet obs) { this(obs.bits, obs.wlen); }
/*     */   
/*     */   public BitSetIterator(long[] bits, int numWords)
/*     */   {
/* 101 */     this.arr = bits;
/* 102 */     this.words = numWords;
/*     */   }
/*     */   
/*     */   private void shift()
/*     */   {
/* 107 */     if ((int)this.word == 0) { this.wordShift += 32;this.word >>>= 32; }
/* 108 */     if ((this.word & 0xFFFF) == 0L) { this.wordShift += 16;this.word >>>= 16; }
/* 109 */     if ((this.word & 0xFF) == 0L) { this.wordShift += 8;this.word >>>= 8; }
/* 110 */     this.indexArray = bitlist[((int)this.word & 0xFF)];
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 137 */     if (this.indexArray == 0) {
/* 138 */       if (this.word != 0L) {
/* 139 */         this.word >>>= 8;
/* 140 */         this.wordShift += 8;
/*     */       }
/*     */       
/* 143 */       while (this.word == 0L) {
/* 144 */         if (++this.i >= this.words) {
/* 145 */           return -1;
/*     */         }
/* 147 */         this.word = this.arr[this.i];
/* 148 */         this.wordShift = -1;
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 156 */     int bitIndex = (this.indexArray & 0xF) + this.wordShift;
/* 157 */     this.indexArray >>>= 4;
/*     */     
/*     */ 
/* 160 */     return (this.i << 6) + bitIndex;
/*     */   }
/*     */ }


/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/BitSetIterator.class
