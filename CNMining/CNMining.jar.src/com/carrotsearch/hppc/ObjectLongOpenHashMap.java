...
/*      */       {
/*  201 */         long oldValue = this.values[slot];
...
/*  230 */     for (ObjectLongCursor<? extends KType> c : container)
/*      */     {
...
/*  245 */     for (ObjectLongCursor<? extends KType> c : iterable)
/*      */     {
...
/*  367 */     long[] oldValues = this.values;
...
/*  416 */     long[] values = new long[capacity];
...
/*      */     
/*  669 */     long previous = this.values[this.lastSlot];
...
/*      */   {
/*  776 */     int h = 0;
/*  777 */     for (ObjectLongCursor<KType> c : this)
/*      */     {
...
/*      */       }
/*  794 */       if ((obj instanceof ObjectLongMap))
/*      */       {
/*      */ 
/*      */ 
/*      */ 
/*  799 */         ObjectLongMap<KType> other = (ObjectLongMap)obj;
/*  800 */         if (other.size() == size())
/*      */         {
/*  802 */           for (ObjectLongCursor<KType> c : this)
/*      */           {
/*  804 */             if (other.containsKey(c.key))
/*      */             {
/*  806 */               long v = other.get(c.key);
/*  807 */               if (c.value == v) {
/*      */                 break;
/*      */               }
/*      */             }
...
/*      */     {
/*  830 */       this.cursor = new ObjectLongCursor();
...
/*  838 */       int max = ObjectLongOpenHashMap.this.keys.length;
/*  839 */       while ((i < max) && (ObjectLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  841 */         i++;
/*      */       }
/*      */       
/*  844 */       if (i == max) {
/*  845 */         return (ObjectLongCursor)done();
/*      */       }
/*  847 */       this.cursor.index = i;
/*  848 */       this.cursor.key = ObjectLongOpenHashMap.this.keys[i];
/*  849 */       this.cursor.value = ObjectLongOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  898 */     private final ObjectLongOpenHashMap<KType> owner = ObjectLongOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(KType e)
/*      */     {
/*  904 */       return ObjectLongOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  949 */       return new ObjectLongOpenHashMap.KeysIterator(ObjectLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/* 1001 */       int max = ObjectLongOpenHashMap.this.keys.length;
/* 1002 */       while ((i < max) && (ObjectLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1004 */         i++;
/*      */       }
/*      */       
...
/* 1011 */       this.cursor.value = ObjectLongOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/* 1034 */       return ObjectLongOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/* 1040 */       return ObjectLongOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/* 1047 */       boolean[] allocated = ObjectLongOpenHashMap.this.allocated;
/* 1048 */       long[] values = ObjectLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1063 */       boolean[] allocated = ObjectLongOpenHashMap.this.allocated;
/* 1064 */       long[] values = ObjectLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1078 */       boolean[] allocated = ObjectLongOpenHashMap.this.allocated;
/* 1079 */       long[] values = ObjectLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1096 */       return new ObjectLongOpenHashMap.ValuesIterator(ObjectLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/* 1127 */       this.cursor = new LongCursor();
...
/* 1135 */       int max = ObjectLongOpenHashMap.this.keys.length;
/* 1136 */       while ((i < max) && (ObjectLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1138 */         i++;
/*      */       }
/*      */       
/* 1141 */       if (i == max) {
/* 1142 */         return (LongCursor)done();
/*      */       }
/* 1144 */       this.cursor.index = i;
/* 1145 */       this.cursor.value = ObjectLongOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1162 */       ObjectLongOpenHashMap<KType> cloned = (ObjectLongOpenHashMap)super.clone();
/*      */       
/*      */ 
/* 1165 */       cloned.keys = ((Object[])this.keys.clone());
/* 1166 */       cloned.values = ((long[])this.values.clone());
...
/* 1187 */     for (ObjectLongCursor<KType> cursor : this)
/*      */     {
...
/*      */     }
/* 1207 */     ObjectLongOpenHashMap<KType> map = new ObjectLongOpenHashMap();
...
/*      */   {
/* 1220 */     return new ObjectLongOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1229 */     return new ObjectLongOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1239 */     new ObjectLongOpenHashMap() {
/*      */       protected int computePerturbationValue(int capacity) {
/* 1241 */         return 0;
/*      */       }
/*      */     };
...
/*      */   {
/* 1251 */     return new ObjectLongOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/ObjectLongOpenHashMap.class
