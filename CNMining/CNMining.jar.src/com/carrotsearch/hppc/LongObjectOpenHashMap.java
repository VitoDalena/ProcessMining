...
/*  214 */     for (LongObjectCursor<? extends VType> c : container)
/*      */     {
...
/*  229 */     for (LongObjectCursor<? extends VType> c : iterable)
/*      */     {
...
/*      */   {
/*  325 */     long[] keys = new long[capacity];
...
/*      */     
/*  434 */     for (LongCursor cursor : container)
/*      */     {
...
/*      */   {
/*  660 */     int h = 0;
/*  661 */     for (LongObjectCursor<VType> c : this)
/*      */     {
...
/*      */       }
/*  678 */       if ((obj instanceof LongObjectMap))
/*      */       {
/*      */ 
/*      */ 
/*      */ 
/*  683 */         LongObjectMap<VType> other = (LongObjectMap)obj;
/*  684 */         if (other.size() == size())
/*      */         {
/*  686 */           for (LongObjectCursor<VType> c : this)
/*      */           {
...
/*      */     {
/*  714 */       this.cursor = new LongObjectCursor();
...
/*  722 */       int max = LongObjectOpenHashMap.this.keys.length;
/*  723 */       while ((i < max) && (LongObjectOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  725 */         i++;
/*      */       }
/*      */       
/*  728 */       if (i == max) {
/*  729 */         return (LongObjectCursor)done();
/*      */       }
/*  731 */       this.cursor.index = i;
/*  732 */       this.cursor.key = LongObjectOpenHashMap.this.keys[i];
/*  733 */       this.cursor.value = LongObjectOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  782 */     private final LongObjectOpenHashMap<VType> owner = LongObjectOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(long e)
/*      */     {
/*  788 */       return LongObjectOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
/*      */     public <T extends LongProcedure> T forEach(T procedure)
/*      */     {
/*  794 */       long[] localKeys = this.owner.keys;
...
/*      */     {
/*  809 */       long[] localKeys = this.owner.keys;
...
/*      */     {
/*  833 */       return new LongObjectOpenHashMap.KeysIterator(LongObjectOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*      */     public KeysIterator()
/*      */     {
/*  877 */       this.cursor = new LongCursor();
...
/*  885 */       int max = LongObjectOpenHashMap.this.keys.length;
/*  886 */       while ((i < max) && (LongObjectOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  888 */         i++;
/*      */       }
/*      */       
/*  891 */       if (i == max) {
/*  892 */         return (LongCursor)done();
/*      */       }
/*  894 */       this.cursor.index = i;
/*  895 */       this.cursor.value = LongObjectOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  918 */       return LongObjectOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  924 */       return LongObjectOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  931 */       boolean[] allocated = LongObjectOpenHashMap.this.allocated;
/*  932 */       VType[] values = LongObjectOpenHashMap.this.values;
/*      */       
...
/*      */     {
/*  947 */       boolean[] allocated = LongObjectOpenHashMap.this.allocated;
/*  948 */       VType[] values = LongObjectOpenHashMap.this.values;
/*      */       
...
/*      */     {
/*  962 */       boolean[] allocated = LongObjectOpenHashMap.this.allocated;
/*  963 */       VType[] values = LongObjectOpenHashMap.this.values;
/*      */       
...
/*      */     {
/*  980 */       return new LongObjectOpenHashMap.ValuesIterator(LongObjectOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/* 1019 */       int max = LongObjectOpenHashMap.this.keys.length;
/* 1020 */       while ((i < max) && (LongObjectOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1022 */         i++;
/*      */       }
/*      */       
...
/* 1029 */       this.cursor.value = LongObjectOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1046 */       LongObjectOpenHashMap<VType> cloned = (LongObjectOpenHashMap)super.clone();
/*      */       
/*      */ 
/* 1049 */       cloned.keys = ((long[])this.keys.clone());
...
/* 1071 */     for (LongObjectCursor<VType> cursor : this)
/*      */     {
...
/*      */     }
/* 1091 */     LongObjectOpenHashMap<VType> map = new LongObjectOpenHashMap();
...
/*      */   {
/* 1104 */     return new LongObjectOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1113 */     return new LongObjectOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1123 */     new LongObjectOpenHashMap() {
/*      */       protected int computePerturbationValue(int capacity) {
/* 1125 */         return 0;
/*      */       }
/*      */     };
...
/*      */   {
/* 1135 */     return new LongObjectOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/LongObjectOpenHashMap.class
