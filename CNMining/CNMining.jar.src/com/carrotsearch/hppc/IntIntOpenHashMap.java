...
/*  213 */     for (IntIntCursor c : container)
/*      */     {
...
/*  228 */     for (IntIntCursor c : iterable)
/*      */     {
...
/*      */       }
/*  747 */       if ((obj instanceof IntIntMap))
/*      */       {
/*      */ 
/*  750 */         IntIntMap other = (IntIntMap)obj;
/*  751 */         if (other.size() == size())
/*      */         {
/*  753 */           for (IntIntCursor c : this)
/*      */           {
...
/*      */     {
/*  781 */       this.cursor = new IntIntCursor();
...
/*  789 */       int max = IntIntOpenHashMap.this.keys.length;
/*  790 */       while ((i < max) && (IntIntOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  792 */         i++;
/*      */       }
/*      */       
/*  795 */       if (i == max) {
/*  796 */         return (IntIntCursor)done();
/*      */       }
/*  798 */       this.cursor.index = i;
/*  799 */       this.cursor.key = IntIntOpenHashMap.this.keys[i];
/*  800 */       this.cursor.value = IntIntOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  849 */     private final IntIntOpenHashMap owner = IntIntOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(int e)
/*      */     {
/*  855 */       return IntIntOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  900 */       return new IntIntOpenHashMap.KeysIterator(IntIntOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*  952 */       int max = IntIntOpenHashMap.this.keys.length;
/*  953 */       while ((i < max) && (IntIntOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  955 */         i++;
/*      */       }
/*      */       
...
/*  962 */       this.cursor.value = IntIntOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  985 */       return IntIntOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  991 */       return IntIntOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  998 */       boolean[] allocated = IntIntOpenHashMap.this.allocated;
/*  999 */       int[] values = IntIntOpenHashMap.this.values;
/*      */       
...
/*      */     public <T extends IntProcedure> T forEach(T procedure)
/*      */     {
/* 1014 */       boolean[] allocated = IntIntOpenHashMap.this.allocated;
/* 1015 */       int[] values = IntIntOpenHashMap.this.values;
/*      */       
...
/*      */     public <T extends IntPredicate> T forEach(T predicate)
/*      */     {
/* 1029 */       boolean[] allocated = IntIntOpenHashMap.this.allocated;
/* 1030 */       int[] values = IntIntOpenHashMap.this.values;
/*      */       
...
/*      */     public Iterator<IntCursor> iterator()
/*      */     {
/* 1047 */       return new IntIntOpenHashMap.ValuesIterator(IntIntOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int removeAllOccurrences(int e)
...
/* 1086 */       int max = IntIntOpenHashMap.this.keys.length;
/* 1087 */       while ((i < max) && (IntIntOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1089 */         i++;
/*      */       }
/*      */       
...
/* 1096 */       this.cursor.value = IntIntOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1111 */       IntIntOpenHashMap cloned = (IntIntOpenHashMap)super.clone();
/*      */       
/*      */ 
...
/* 1136 */     for (IntIntCursor cursor : this)
/*      */     {
...
/*      */     }
/* 1156 */     IntIntOpenHashMap map = new IntIntOpenHashMap();
...
/*      */   {
/* 1169 */     return new IntIntOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1178 */     return new IntIntOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1200 */     return new IntIntOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/IntIntOpenHashMap.class
