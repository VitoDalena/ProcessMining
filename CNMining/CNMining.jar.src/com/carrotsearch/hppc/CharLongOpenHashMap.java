...
/*  213 */     for (CharLongCursor c : container)
/*      */     {
...
/*  228 */     for (CharLongCursor c : iterable)
/*      */     {
...
/*      */       }
/*  747 */       if ((obj instanceof CharLongMap))
/*      */       {
/*      */ 
/*  750 */         CharLongMap other = (CharLongMap)obj;
/*  751 */         if (other.size() == size())
/*      */         {
/*  753 */           for (CharLongCursor c : this)
/*      */           {
...
/*      */     {
/*  781 */       this.cursor = new CharLongCursor();
...
/*  789 */       int max = CharLongOpenHashMap.this.keys.length;
/*  790 */       while ((i < max) && (CharLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  792 */         i++;
/*      */       }
/*      */       
/*  795 */       if (i == max) {
/*  796 */         return (CharLongCursor)done();
/*      */       }
/*  798 */       this.cursor.index = i;
/*  799 */       this.cursor.key = CharLongOpenHashMap.this.keys[i];
/*  800 */       this.cursor.value = CharLongOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  849 */     private final CharLongOpenHashMap owner = CharLongOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(char e)
/*      */     {
/*  855 */       return CharLongOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  900 */       return new CharLongOpenHashMap.KeysIterator(CharLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*  952 */       int max = CharLongOpenHashMap.this.keys.length;
/*  953 */       while ((i < max) && (CharLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  955 */         i++;
/*      */       }
/*      */       
...
/*  962 */       this.cursor.value = CharLongOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  985 */       return CharLongOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  991 */       return CharLongOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  998 */       boolean[] allocated = CharLongOpenHashMap.this.allocated;
/*  999 */       long[] values = CharLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1014 */       boolean[] allocated = CharLongOpenHashMap.this.allocated;
/* 1015 */       long[] values = CharLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1029 */       boolean[] allocated = CharLongOpenHashMap.this.allocated;
/* 1030 */       long[] values = CharLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1047 */       return new CharLongOpenHashMap.ValuesIterator(CharLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/* 1086 */       int max = CharLongOpenHashMap.this.keys.length;
/* 1087 */       while ((i < max) && (CharLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1089 */         i++;
/*      */       }
/*      */       
...
/* 1096 */       this.cursor.value = CharLongOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1111 */       CharLongOpenHashMap cloned = (CharLongOpenHashMap)super.clone();
/*      */       
/*      */ 
...
/* 1136 */     for (CharLongCursor cursor : this)
/*      */     {
...
/*      */     }
/* 1156 */     CharLongOpenHashMap map = new CharLongOpenHashMap();
...
/*      */   {
/* 1169 */     return new CharLongOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1178 */     return new CharLongOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1200 */     return new CharLongOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/CharLongOpenHashMap.class
