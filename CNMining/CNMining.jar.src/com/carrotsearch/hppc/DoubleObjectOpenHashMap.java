...
/*      */     {
/*  183 */       if (Double.doubleToLongBits(key) == Double.doubleToLongBits(this.keys[slot]))
/*      */       {
...
/*  214 */     for (DoubleObjectCursor<? extends VType> c : container)
/*      */     {
...
/*  229 */     for (DoubleObjectCursor<? extends VType> c : iterable)
/*      */     {
...
/*      */   {
/*  325 */     double[] keys = new double[capacity];
...
/*      */     {
/*  366 */       if (Double.doubleToLongBits(key) == Double.doubleToLongBits(this.keys[slot]))
/*      */       {
/*  368 */         this.assigned -= 1;
...
/*      */     
/*  434 */     for (DoubleCursor cursor : container)
/*      */     {
...
/*      */     {
/*  496 */       if (Double.doubleToLongBits(key) == Double.doubleToLongBits(this.keys[slot]))
/*      */       {
...
/*      */     {
/*  518 */       if (Double.doubleToLongBits(key) == Double.doubleToLongBits(this.keys[slot]))
/*      */       {
...
/*      */     {
/*  602 */       if (Double.doubleToLongBits(key) == Double.doubleToLongBits(this.keys[slot]))
/*      */       {
...
/*      */   {
/*  660 */     int h = 0;
/*  661 */     for (DoubleObjectCursor<VType> c : this)
/*      */     {
...
/*      */       }
/*  678 */       if ((obj instanceof DoubleObjectMap))
/*      */       {
/*      */ 
/*      */ 
/*      */ 
/*  683 */         DoubleObjectMap<VType> other = (DoubleObjectMap)obj;
/*  684 */         if (other.size() == size())
/*      */         {
/*  686 */           for (DoubleObjectCursor<VType> c : this)
/*      */           {
...
/*      */     {
/*  714 */       this.cursor = new DoubleObjectCursor();
...
/*  722 */       int max = DoubleObjectOpenHashMap.this.keys.length;
/*  723 */       while ((i < max) && (DoubleObjectOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  725 */         i++;
/*      */       }
/*      */       
/*  728 */       if (i == max) {
/*  729 */         return (DoubleObjectCursor)done();
/*      */       }
/*  731 */       this.cursor.index = i;
/*  732 */       this.cursor.key = DoubleObjectOpenHashMap.this.keys[i];
/*  733 */       this.cursor.value = DoubleObjectOpenHashMap.this.values[i];
/*      */       
...
/*      */ 
/*      */ 
/*      */   public DoubleObjectOpenHashMap<VType>.KeysContainer keys()
/*      */   {
...
/*      */   {
/*  782 */     private final DoubleObjectOpenHashMap<VType> owner = DoubleObjectOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(double e)
/*      */     {
/*  788 */       return DoubleObjectOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
/*      */     public <T extends DoubleProcedure> T forEach(T procedure)
/*      */     {
/*  794 */       double[] localKeys = this.owner.keys;
...
/*      */     {
/*  809 */       double[] localKeys = this.owner.keys;
...
/*      */     {
/*  833 */       return new DoubleObjectOpenHashMap.KeysIterator(DoubleObjectOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*      */     public KeysIterator()
/*      */     {
/*  877 */       this.cursor = new DoubleCursor();
...
/*  885 */       int max = DoubleObjectOpenHashMap.this.keys.length;
/*  886 */       while ((i < max) && (DoubleObjectOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  888 */         i++;
/*      */       }
/*      */       
/*  891 */       if (i == max) {
/*  892 */         return (DoubleCursor)done();
/*      */       }
/*  894 */       this.cursor.index = i;
/*  895 */       this.cursor.value = DoubleObjectOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  918 */       return DoubleObjectOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  924 */       return DoubleObjectOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  931 */       boolean[] allocated = DoubleObjectOpenHashMap.this.allocated;
/*  932 */       VType[] values = DoubleObjectOpenHashMap.this.values;
/*      */       
...
/*      */     {
/*  947 */       boolean[] allocated = DoubleObjectOpenHashMap.this.allocated;
/*  948 */       VType[] values = DoubleObjectOpenHashMap.this.values;
/*      */       
...
/*      */     {
/*  962 */       boolean[] allocated = DoubleObjectOpenHashMap.this.allocated;
/*  963 */       VType[] values = DoubleObjectOpenHashMap.this.values;
/*      */       
...
/*      */     {
/*  980 */       return new DoubleObjectOpenHashMap.ValuesIterator(DoubleObjectOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/* 1019 */       int max = DoubleObjectOpenHashMap.this.keys.length;
/* 1020 */       while ((i < max) && (DoubleObjectOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1022 */         i++;
/*      */       }
/*      */       
...
/* 1029 */       this.cursor.value = DoubleObjectOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1046 */       DoubleObjectOpenHashMap<VType> cloned = (DoubleObjectOpenHashMap)super.clone();
/*      */       
/*      */ 
/* 1049 */       cloned.keys = ((double[])this.keys.clone());
...
/* 1071 */     for (DoubleObjectCursor<VType> cursor : this)
/*      */     {
...
/*      */     }
/* 1091 */     DoubleObjectOpenHashMap<VType> map = new DoubleObjectOpenHashMap();
...
/*      */   {
/* 1104 */     return new DoubleObjectOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1113 */     return new DoubleObjectOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1123 */     new DoubleObjectOpenHashMap() {
/*      */       protected int computePerturbationValue(int capacity) {
/* 1125 */         return 0;
/*      */       }
/*      */     };
...
/*      */   {
/* 1135 */     return new DoubleObjectOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/DoubleObjectOpenHashMap.class
