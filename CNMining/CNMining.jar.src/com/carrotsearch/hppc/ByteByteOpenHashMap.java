...
/*      */       {
/*  184 */         byte oldValue = this.values[slot];
...
/*      */ 
/*      */ 
/*      */   public int putAll(ByteByteAssociativeContainer container)
/*      */   {
/*  212 */     int count = this.assigned;
/*  213 */     for (ByteByteCursor c : container)
/*      */     {
...
/*  228 */     for (ByteByteCursor c : iterable)
/*      */     {
...
/*      */       {
/*  293 */         return this.values[slot] = (byte)(this.values[slot] + additionValue);
/*      */       }
/*      */       
...
/*  350 */     byte[] oldValues = this.values;
...
/*  399 */     byte[] values = new byte[capacity];
...
/*      */     
/*  628 */     byte previous = this.values[this.lastSlot];
...
/*      */       }
/*  747 */       if ((obj instanceof ByteByteMap))
/*      */       {
/*      */ 
/*  750 */         ByteByteMap other = (ByteByteMap)obj;
/*  751 */         if (other.size() == size())
/*      */         {
/*  753 */           for (ByteByteCursor c : this)
/*      */           {
/*  755 */             if (other.containsKey(c.key))
/*      */             {
/*  757 */               byte v = other.get(c.key);
/*  758 */               if (c.value == v) {
/*      */                 break;
/*      */               }
/*      */             }
...
/*      */     extends AbstractIterator<ByteByteCursor>
/*      */   {
...
/*      */     {
/*  781 */       this.cursor = new ByteByteCursor();
...
/*  789 */       int max = ByteByteOpenHashMap.this.keys.length;
/*  790 */       while ((i < max) && (ByteByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  792 */         i++;
/*      */       }
/*      */       
/*  795 */       if (i == max) {
/*  796 */         return (ByteByteCursor)done();
/*      */       }
/*  798 */       this.cursor.index = i;
/*  799 */       this.cursor.key = ByteByteOpenHashMap.this.keys[i];
/*  800 */       this.cursor.value = ByteByteOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  849 */     private final ByteByteOpenHashMap owner = ByteByteOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(byte e)
/*      */     {
/*  855 */       return ByteByteOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  900 */       return new ByteByteOpenHashMap.KeysIterator(ByteByteOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*  952 */       int max = ByteByteOpenHashMap.this.keys.length;
/*  953 */       while ((i < max) && (ByteByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  955 */         i++;
/*      */       }
/*      */       
...
/*  962 */       this.cursor.value = ByteByteOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  985 */       return ByteByteOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  991 */       return ByteByteOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  998 */       boolean[] allocated = ByteByteOpenHashMap.this.allocated;
/*  999 */       byte[] values = ByteByteOpenHashMap.this.values;
/*      */       
...
/*      */     public <T extends ByteProcedure> T forEach(T procedure)
/*      */     {
/* 1014 */       boolean[] allocated = ByteByteOpenHashMap.this.allocated;
/* 1015 */       byte[] values = ByteByteOpenHashMap.this.values;
/*      */       
...
/*      */     public <T extends BytePredicate> T forEach(T predicate)
/*      */     {
/* 1029 */       boolean[] allocated = ByteByteOpenHashMap.this.allocated;
/* 1030 */       byte[] values = ByteByteOpenHashMap.this.values;
/*      */       
...
/*      */     public Iterator<ByteCursor> iterator()
/*      */     {
/* 1047 */       return new ByteByteOpenHashMap.ValuesIterator(ByteByteOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int removeAllOccurrences(byte e)
...
/*      */     {
/* 1078 */       this.cursor = new ByteCursor();
...
/* 1086 */       int max = ByteByteOpenHashMap.this.keys.length;
/* 1087 */       while ((i < max) && (ByteByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1089 */         i++;
/*      */       }
/*      */       
/* 1092 */       if (i == max) {
/* 1093 */         return (ByteCursor)done();
/*      */       }
/* 1095 */       this.cursor.index = i;
/* 1096 */       this.cursor.value = ByteByteOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1111 */       ByteByteOpenHashMap cloned = (ByteByteOpenHashMap)super.clone();
/*      */       
/*      */ 
/* 1114 */       cloned.keys = ((byte[])this.keys.clone());
/* 1115 */       cloned.values = ((byte[])this.values.clone());
...
/* 1136 */     for (ByteByteCursor cursor : this)
/*      */     {
...
/*      */     }
/* 1156 */     ByteByteOpenHashMap map = new ByteByteOpenHashMap();
...
/*      */   {
/* 1169 */     return new ByteByteOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1178 */     return new ByteByteOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1200 */     return new ByteByteOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/ByteByteOpenHashMap.class
