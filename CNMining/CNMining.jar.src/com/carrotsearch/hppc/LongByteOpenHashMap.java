...
/*  213 */     for (LongByteCursor c : container)
/*      */     {
...
/*  228 */     for (LongByteCursor c : iterable)
/*      */     {
...
/*      */       }
/*  747 */       if ((obj instanceof LongByteMap))
/*      */       {
/*      */ 
/*  750 */         LongByteMap other = (LongByteMap)obj;
/*  751 */         if (other.size() == size())
/*      */         {
/*  753 */           for (LongByteCursor c : this)
/*      */           {
...
/*      */     {
/*  781 */       this.cursor = new LongByteCursor();
...
/*  789 */       int max = LongByteOpenHashMap.this.keys.length;
/*  790 */       while ((i < max) && (LongByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  792 */         i++;
/*      */       }
/*      */       
/*  795 */       if (i == max) {
/*  796 */         return (LongByteCursor)done();
/*      */       }
/*  798 */       this.cursor.index = i;
/*  799 */       this.cursor.key = LongByteOpenHashMap.this.keys[i];
/*  800 */       this.cursor.value = LongByteOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  849 */     private final LongByteOpenHashMap owner = LongByteOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(long e)
/*      */     {
/*  855 */       return LongByteOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  900 */       return new LongByteOpenHashMap.KeysIterator(LongByteOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*  952 */       int max = LongByteOpenHashMap.this.keys.length;
/*  953 */       while ((i < max) && (LongByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  955 */         i++;
/*      */       }
/*      */       
...
/*  962 */       this.cursor.value = LongByteOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  985 */       return LongByteOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  991 */       return LongByteOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  998 */       boolean[] allocated = LongByteOpenHashMap.this.allocated;
/*  999 */       byte[] values = LongByteOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1014 */       boolean[] allocated = LongByteOpenHashMap.this.allocated;
/* 1015 */       byte[] values = LongByteOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1029 */       boolean[] allocated = LongByteOpenHashMap.this.allocated;
/* 1030 */       byte[] values = LongByteOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1047 */       return new LongByteOpenHashMap.ValuesIterator(LongByteOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/* 1086 */       int max = LongByteOpenHashMap.this.keys.length;
/* 1087 */       while ((i < max) && (LongByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1089 */         i++;
/*      */       }
/*      */       
...
/* 1096 */       this.cursor.value = LongByteOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1111 */       LongByteOpenHashMap cloned = (LongByteOpenHashMap)super.clone();
/*      */       
/*      */ 
...
/* 1136 */     for (LongByteCursor cursor : this)
/*      */     {
...
/*      */     }
/* 1156 */     LongByteOpenHashMap map = new LongByteOpenHashMap();
...
/*      */   {
/* 1169 */     return new LongByteOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1178 */     return new LongByteOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1200 */     return new LongByteOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/LongByteOpenHashMap.class
