...
/*      */       {
/*  184 */         long oldValue = this.values[slot];
...
/*      */ 
/*      */ 
/*      */   public int putAll(FloatLongAssociativeContainer container)
/*      */   {
/*  212 */     int count = this.assigned;
/*  213 */     for (FloatLongCursor c : container)
/*      */     {
...
/*      */ 
/*      */ 
/*      */   public int putAll(Iterable<? extends FloatLongCursor> iterable)
/*      */   {
/*  227 */     int count = this.assigned;
/*  228 */     for (FloatLongCursor c : iterable)
/*      */     {
...
/*  350 */     long[] oldValues = this.values;
...
/*  399 */     long[] values = new long[capacity];
...
/*      */     
/*  628 */     long previous = this.values[this.lastSlot];
...
/*      */   {
/*  729 */     int h = 0;
/*  730 */     for (FloatLongCursor c : this)
/*      */     {
...
/*      */       }
/*  747 */       if ((obj instanceof FloatLongMap))
/*      */       {
/*      */ 
/*  750 */         FloatLongMap other = (FloatLongMap)obj;
/*  751 */         if (other.size() == size())
/*      */         {
/*  753 */           for (FloatLongCursor c : this)
/*      */           {
/*  755 */             if (other.containsKey(c.key))
/*      */             {
/*  757 */               long v = other.get(c.key);
/*  758 */               if (c.value == v) {
/*      */                 break;
/*      */               }
/*      */             }
...
/*      */     extends AbstractIterator<FloatLongCursor>
/*      */   {
...
/*      */     {
/*  781 */       this.cursor = new FloatLongCursor();
...
/*  789 */       int max = FloatLongOpenHashMap.this.keys.length;
/*  790 */       while ((i < max) && (FloatLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  792 */         i++;
/*      */       }
/*      */       
/*  795 */       if (i == max) {
/*  796 */         return (FloatLongCursor)done();
/*      */       }
/*  798 */       this.cursor.index = i;
/*  799 */       this.cursor.key = FloatLongOpenHashMap.this.keys[i];
/*  800 */       this.cursor.value = FloatLongOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  849 */     private final FloatLongOpenHashMap owner = FloatLongOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(float e)
/*      */     {
/*  855 */       return FloatLongOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  900 */       return new FloatLongOpenHashMap.KeysIterator(FloatLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*  952 */       int max = FloatLongOpenHashMap.this.keys.length;
/*  953 */       while ((i < max) && (FloatLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  955 */         i++;
/*      */       }
/*      */       
...
/*  962 */       this.cursor.value = FloatLongOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  985 */       return FloatLongOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  991 */       return FloatLongOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  998 */       boolean[] allocated = FloatLongOpenHashMap.this.allocated;
/*  999 */       long[] values = FloatLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1014 */       boolean[] allocated = FloatLongOpenHashMap.this.allocated;
/* 1015 */       long[] values = FloatLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1029 */       boolean[] allocated = FloatLongOpenHashMap.this.allocated;
/* 1030 */       long[] values = FloatLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1047 */       return new FloatLongOpenHashMap.ValuesIterator(FloatLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/* 1078 */       this.cursor = new LongCursor();
...
/* 1086 */       int max = FloatLongOpenHashMap.this.keys.length;
/* 1087 */       while ((i < max) && (FloatLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1089 */         i++;
/*      */       }
/*      */       
/* 1092 */       if (i == max) {
/* 1093 */         return (LongCursor)done();
/*      */       }
/* 1095 */       this.cursor.index = i;
/* 1096 */       this.cursor.value = FloatLongOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1111 */       FloatLongOpenHashMap cloned = (FloatLongOpenHashMap)super.clone();
/*      */       
/*      */ 
/* 1114 */       cloned.keys = ((float[])this.keys.clone());
/* 1115 */       cloned.values = ((long[])this.values.clone());
...
/* 1136 */     for (FloatLongCursor cursor : this)
/*      */     {
...
/*      */     }
/* 1156 */     FloatLongOpenHashMap map = new FloatLongOpenHashMap();
...
/*      */   {
/* 1169 */     return new FloatLongOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1178 */     return new FloatLongOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1200 */     return new FloatLongOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/FloatLongOpenHashMap.class
