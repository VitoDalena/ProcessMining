...
/*  213 */     for (DoubleByteCursor c : container)
/*      */     {
...
/*  228 */     for (DoubleByteCursor c : iterable)
/*      */     {
...
/*      */   {
/*  729 */     int h = 0;
/*  730 */     for (DoubleByteCursor c : this)
/*      */     {
...
/*      */       }
/*  747 */       if ((obj instanceof DoubleByteMap))
/*      */       {
/*      */ 
/*  750 */         DoubleByteMap other = (DoubleByteMap)obj;
/*  751 */         if (other.size() == size())
/*      */         {
/*  753 */           for (DoubleByteCursor c : this)
/*      */           {
...
/*      */     {
/*  781 */       this.cursor = new DoubleByteCursor();
...
/*  789 */       int max = DoubleByteOpenHashMap.this.keys.length;
/*  790 */       while ((i < max) && (DoubleByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  792 */         i++;
/*      */       }
/*      */       
/*  795 */       if (i == max) {
/*  796 */         return (DoubleByteCursor)done();
/*      */       }
/*  798 */       this.cursor.index = i;
/*  799 */       this.cursor.key = DoubleByteOpenHashMap.this.keys[i];
/*  800 */       this.cursor.value = DoubleByteOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  849 */     private final DoubleByteOpenHashMap owner = DoubleByteOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(double e)
/*      */     {
/*  855 */       return DoubleByteOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  900 */       return new DoubleByteOpenHashMap.KeysIterator(DoubleByteOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*  952 */       int max = DoubleByteOpenHashMap.this.keys.length;
/*  953 */       while ((i < max) && (DoubleByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  955 */         i++;
/*      */       }
/*      */       
...
/*  962 */       this.cursor.value = DoubleByteOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  985 */       return DoubleByteOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  991 */       return DoubleByteOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  998 */       boolean[] allocated = DoubleByteOpenHashMap.this.allocated;
/*  999 */       byte[] values = DoubleByteOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1014 */       boolean[] allocated = DoubleByteOpenHashMap.this.allocated;
/* 1015 */       byte[] values = DoubleByteOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1029 */       boolean[] allocated = DoubleByteOpenHashMap.this.allocated;
/* 1030 */       byte[] values = DoubleByteOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1047 */       return new DoubleByteOpenHashMap.ValuesIterator(DoubleByteOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/* 1086 */       int max = DoubleByteOpenHashMap.this.keys.length;
/* 1087 */       while ((i < max) && (DoubleByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1089 */         i++;
/*      */       }
/*      */       
...
/* 1096 */       this.cursor.value = DoubleByteOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1111 */       DoubleByteOpenHashMap cloned = (DoubleByteOpenHashMap)super.clone();
/*      */       
/*      */ 
...
/* 1136 */     for (DoubleByteCursor cursor : this)
/*      */     {
...
/*      */     }
/* 1156 */     DoubleByteOpenHashMap map = new DoubleByteOpenHashMap();
...
/*      */   {
/* 1169 */     return new DoubleByteOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1178 */     return new DoubleByteOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1188 */     new DoubleByteOpenHashMap() {
/*      */       protected int computePerturbationValue(int capacity) {
/* 1190 */         return 0;
/*      */       }
/*      */     };
...
/*      */   {
/* 1200 */     return new DoubleByteOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/DoubleByteOpenHashMap.class
