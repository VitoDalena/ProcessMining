...
/*      */       {
/*  201 */         byte oldValue = this.values[slot];
...
/*  230 */     for (ObjectByteCursor<? extends KType> c : container)
/*      */     {
...
/*  245 */     for (ObjectByteCursor<? extends KType> c : iterable)
/*      */     {
...
/*      */       {
/*  310 */         return this.values[slot] = (byte)(this.values[slot] + additionValue);
/*      */       }
/*      */       
...
/*  367 */     byte[] oldValues = this.values;
...
/*  416 */     byte[] values = new byte[capacity];
...
/*      */     
/*  669 */     byte previous = this.values[this.lastSlot];
...
/*      */   {
/*  776 */     int h = 0;
/*  777 */     for (ObjectByteCursor<KType> c : this)
/*      */     {
...
/*      */       }
/*  794 */       if ((obj instanceof ObjectByteMap))
/*      */       {
/*      */ 
/*      */ 
/*      */ 
/*  799 */         ObjectByteMap<KType> other = (ObjectByteMap)obj;
/*  800 */         if (other.size() == size())
/*      */         {
/*  802 */           for (ObjectByteCursor<KType> c : this)
/*      */           {
/*  804 */             if (other.containsKey(c.key))
/*      */             {
/*  806 */               byte v = other.get(c.key);
/*  807 */               if (c.value == v) {
/*      */                 break;
/*      */               }
/*      */             }
...
/*      */     {
/*  830 */       this.cursor = new ObjectByteCursor();
...
/*  838 */       int max = ObjectByteOpenHashMap.this.keys.length;
/*  839 */       while ((i < max) && (ObjectByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  841 */         i++;
/*      */       }
/*      */       
/*  844 */       if (i == max) {
/*  845 */         return (ObjectByteCursor)done();
/*      */       }
/*  847 */       this.cursor.index = i;
/*  848 */       this.cursor.key = ObjectByteOpenHashMap.this.keys[i];
/*  849 */       this.cursor.value = ObjectByteOpenHashMap.this.values[i];
/*      */       
...
/*      */ 
/*      */ 
/*      */   public ObjectByteOpenHashMap<KType>.KeysContainer keys()
/*      */   {
...
/*      */   {
/*  898 */     private final ObjectByteOpenHashMap<KType> owner = ObjectByteOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(KType e)
/*      */     {
/*  904 */       return ObjectByteOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  949 */       return new ObjectByteOpenHashMap.KeysIterator(ObjectByteOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/* 1001 */       int max = ObjectByteOpenHashMap.this.keys.length;
/* 1002 */       while ((i < max) && (ObjectByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1004 */         i++;
/*      */       }
/*      */       
...
/* 1011 */       this.cursor.value = ObjectByteOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/* 1034 */       return ObjectByteOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/* 1040 */       return ObjectByteOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/* 1047 */       boolean[] allocated = ObjectByteOpenHashMap.this.allocated;
/* 1048 */       byte[] values = ObjectByteOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1063 */       boolean[] allocated = ObjectByteOpenHashMap.this.allocated;
/* 1064 */       byte[] values = ObjectByteOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1078 */       boolean[] allocated = ObjectByteOpenHashMap.this.allocated;
/* 1079 */       byte[] values = ObjectByteOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1096 */       return new ObjectByteOpenHashMap.ValuesIterator(ObjectByteOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/* 1127 */       this.cursor = new ByteCursor();
...
/* 1135 */       int max = ObjectByteOpenHashMap.this.keys.length;
/* 1136 */       while ((i < max) && (ObjectByteOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1138 */         i++;
/*      */       }
/*      */       
/* 1141 */       if (i == max) {
/* 1142 */         return (ByteCursor)done();
/*      */       }
/* 1144 */       this.cursor.index = i;
/* 1145 */       this.cursor.value = ObjectByteOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1162 */       ObjectByteOpenHashMap<KType> cloned = (ObjectByteOpenHashMap)super.clone();
/*      */       
/*      */ 
/* 1165 */       cloned.keys = ((Object[])this.keys.clone());
/* 1166 */       cloned.values = ((byte[])this.values.clone());
...
/* 1187 */     for (ObjectByteCursor<KType> cursor : this)
/*      */     {
...
/*      */     }
/* 1207 */     ObjectByteOpenHashMap<KType> map = new ObjectByteOpenHashMap();
...
/*      */   {
/* 1220 */     return new ObjectByteOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1229 */     return new ObjectByteOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1239 */     new ObjectByteOpenHashMap() {
/*      */       protected int computePerturbationValue(int capacity) {
/* 1241 */         return 0;
/*      */       }
/*      */     };
...
/*      */   {
/* 1251 */     return new ObjectByteOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/ObjectByteOpenHashMap.class
