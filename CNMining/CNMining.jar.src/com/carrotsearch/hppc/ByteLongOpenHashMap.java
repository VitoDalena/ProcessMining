...
/*      */ 
/*      */ 
/*      */   public int putAll(ByteLongAssociativeContainer container)
/*      */   {
/*  212 */     int count = this.assigned;
/*  213 */     for (ByteLongCursor c : container)
/*      */     {
...
/*  228 */     for (ByteLongCursor c : iterable)
/*      */     {
...
/*      */       }
/*  747 */       if ((obj instanceof ByteLongMap))
/*      */       {
/*      */ 
/*  750 */         ByteLongMap other = (ByteLongMap)obj;
/*  751 */         if (other.size() == size())
/*      */         {
/*  753 */           for (ByteLongCursor c : this)
/*      */           {
...
/*      */     extends AbstractIterator<ByteLongCursor>
/*      */   {
...
/*      */     {
/*  781 */       this.cursor = new ByteLongCursor();
...
/*  789 */       int max = ByteLongOpenHashMap.this.keys.length;
/*  790 */       while ((i < max) && (ByteLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  792 */         i++;
/*      */       }
/*      */       
/*  795 */       if (i == max) {
/*  796 */         return (ByteLongCursor)done();
/*      */       }
/*  798 */       this.cursor.index = i;
/*  799 */       this.cursor.key = ByteLongOpenHashMap.this.keys[i];
/*  800 */       this.cursor.value = ByteLongOpenHashMap.this.values[i];
/*      */       
...
/*      */   {
/*  849 */     private final ByteLongOpenHashMap owner = ByteLongOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(byte e)
/*      */     {
/*  855 */       return ByteLongOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  900 */       return new ByteLongOpenHashMap.KeysIterator(ByteLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/*  952 */       int max = ByteLongOpenHashMap.this.keys.length;
/*  953 */       while ((i < max) && (ByteLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  955 */         i++;
/*      */       }
/*      */       
...
/*  962 */       this.cursor.value = ByteLongOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/*  985 */       return ByteLongOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/*  991 */       return ByteLongOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/*  998 */       boolean[] allocated = ByteLongOpenHashMap.this.allocated;
/*  999 */       long[] values = ByteLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1014 */       boolean[] allocated = ByteLongOpenHashMap.this.allocated;
/* 1015 */       long[] values = ByteLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1029 */       boolean[] allocated = ByteLongOpenHashMap.this.allocated;
/* 1030 */       long[] values = ByteLongOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1047 */       return new ByteLongOpenHashMap.ValuesIterator(ByteLongOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/* 1086 */       int max = ByteLongOpenHashMap.this.keys.length;
/* 1087 */       while ((i < max) && (ByteLongOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1089 */         i++;
/*      */       }
/*      */       
...
/* 1096 */       this.cursor.value = ByteLongOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1111 */       ByteLongOpenHashMap cloned = (ByteLongOpenHashMap)super.clone();
/*      */       
/*      */ 
...
/* 1136 */     for (ByteLongCursor cursor : this)
/*      */     {
...
/*      */     }
/* 1156 */     ByteLongOpenHashMap map = new ByteLongOpenHashMap();
...
/*      */   {
/* 1169 */     return new ByteLongOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1178 */     return new ByteLongOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1200 */     return new ByteLongOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/ByteLongOpenHashMap.class
