...
/*      */       {
/*  201 */         float oldValue = this.values[slot];
...
/*  230 */     for (ObjectFloatCursor<? extends KType> c : container)
/*      */     {
...
/*  245 */     for (ObjectFloatCursor<? extends KType> c : iterable)
/*      */     {
...
/*  367 */     float[] oldValues = this.values;
...
/*  416 */     float[] values = new float[capacity];
...
/*      */     
/*  669 */     float previous = this.values[this.lastSlot];
...
/*      */   {
/*  776 */     int h = 0;
/*  777 */     for (ObjectFloatCursor<KType> c : this)
/*      */     {
...
/*      */       }
/*  794 */       if ((obj instanceof ObjectFloatMap))
/*      */       {
/*      */ 
/*      */ 
/*      */ 
/*  799 */         ObjectFloatMap<KType> other = (ObjectFloatMap)obj;
/*  800 */         if (other.size() == size())
/*      */         {
/*  802 */           for (ObjectFloatCursor<KType> c : this)
/*      */           {
/*  804 */             if (other.containsKey(c.key))
/*      */             {
/*  806 */               float v = other.get(c.key);
/*  807 */               if (Float.floatToIntBits(c.value) == Float.floatToIntBits(v)) {
/*      */                 break;
/*      */               }
/*      */             }
/*      */             else {
...
/*      */     {
/*  830 */       this.cursor = new ObjectFloatCursor();
...
/*  838 */       int max = ObjectFloatOpenHashMap.this.keys.length;
/*  839 */       while ((i < max) && (ObjectFloatOpenHashMap.this.allocated[i] == 0))
/*      */       {
/*  841 */         i++;
/*      */       }
/*      */       
/*  844 */       if (i == max) {
/*  845 */         return (ObjectFloatCursor)done();
/*      */       }
/*  847 */       this.cursor.index = i;
/*  848 */       this.cursor.key = ObjectFloatOpenHashMap.this.keys[i];
/*  849 */       this.cursor.value = ObjectFloatOpenHashMap.this.values[i];
/*      */       
...
/*      */ 
/*      */ 
/*      */   public ObjectFloatOpenHashMap<KType>.KeysContainer keys()
/*      */   {
...
/*      */   {
/*  898 */     private final ObjectFloatOpenHashMap<KType> owner = ObjectFloatOpenHashMap.this;
/*      */     
/*      */     public KeysContainer() {}
/*      */     
/*      */     public boolean contains(KType e)
/*      */     {
/*  904 */       return ObjectFloatOpenHashMap.this.containsKey(e);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/*  949 */       return new ObjectFloatOpenHashMap.KeysIterator(ObjectFloatOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
/*      */     public int size()
...
/* 1001 */       int max = ObjectFloatOpenHashMap.this.keys.length;
/* 1002 */       while ((i < max) && (ObjectFloatOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1004 */         i++;
/*      */       }
/*      */       
...
/* 1011 */       this.cursor.value = ObjectFloatOpenHashMap.this.keys[i];
/*      */       
...
/*      */     public int size()
/*      */     {
/* 1034 */       return ObjectFloatOpenHashMap.this.size();
/*      */     }
/*      */     
/*      */ 
/*      */     public boolean isEmpty()
/*      */     {
/* 1040 */       return ObjectFloatOpenHashMap.this.isEmpty();
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */     {
/* 1047 */       boolean[] allocated = ObjectFloatOpenHashMap.this.allocated;
/* 1048 */       float[] values = ObjectFloatOpenHashMap.this.values;
/*      */       
/* 1050 */       for (int slot = 0; slot < allocated.length; slot++)
/*      */       {
/* 1052 */         if ((allocated[slot] != 0) && (Float.floatToIntBits(value) == Float.floatToIntBits(values[slot])))
/*      */         {
/* 1054 */           return true;
/*      */         }
/*      */       }
...
/*      */     {
/* 1063 */       boolean[] allocated = ObjectFloatOpenHashMap.this.allocated;
/* 1064 */       float[] values = ObjectFloatOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1078 */       boolean[] allocated = ObjectFloatOpenHashMap.this.allocated;
/* 1079 */       float[] values = ObjectFloatOpenHashMap.this.values;
/*      */       
...
/*      */     {
/* 1096 */       return new ObjectFloatOpenHashMap.ValuesIterator(ObjectFloatOpenHashMap.this);
/*      */     }
/*      */     
/*      */ 
...
/*      */     {
/* 1127 */       this.cursor = new FloatCursor();
...
/* 1135 */       int max = ObjectFloatOpenHashMap.this.keys.length;
/* 1136 */       while ((i < max) && (ObjectFloatOpenHashMap.this.allocated[i] == 0))
/*      */       {
/* 1138 */         i++;
/*      */       }
/*      */       
/* 1141 */       if (i == max) {
/* 1142 */         return (FloatCursor)done();
/*      */       }
/* 1144 */       this.cursor.index = i;
/* 1145 */       this.cursor.value = ObjectFloatOpenHashMap.this.values[i];
/*      */       
...
/*      */     try
/*      */     {
/* 1162 */       ObjectFloatOpenHashMap<KType> cloned = (ObjectFloatOpenHashMap)super.clone();
/*      */       
/*      */ 
/* 1165 */       cloned.keys = ((Object[])this.keys.clone());
/* 1166 */       cloned.values = ((float[])this.values.clone());
...
/* 1187 */     for (ObjectFloatCursor<KType> cursor : this)
/*      */     {
...
/*      */     }
/* 1207 */     ObjectFloatOpenHashMap<KType> map = new ObjectFloatOpenHashMap();
...
/*      */   {
/* 1220 */     return new ObjectFloatOpenHashMap(container);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1229 */     return new ObjectFloatOpenHashMap();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1239 */     new ObjectFloatOpenHashMap() {
/*      */       protected int computePerturbationValue(int capacity) {
/* 1241 */         return 0;
/*      */       }
/*      */     };
...
/*      */   {
/* 1251 */     return new ObjectFloatOpenHashMap(initialCapacity, loadFactor);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/com/carrotsearch/hppc/ObjectFloatOpenHashMap.class
