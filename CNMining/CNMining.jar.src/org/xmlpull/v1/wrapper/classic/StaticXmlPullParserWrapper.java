...
/*     */     } catch (NumberFormatException ex) { double d;
/* 155 */       if ((value.equals("INF")) || (value.toLowerCase().equals("infinity"))) {
/* 156 */         d = Double.POSITIVE_INFINITY; } else { double d;
/* 157 */         if ((value.equals("-INF")) || (value.toLowerCase().equals("-infinity")))
/*     */         {
/* 159 */           d = Double.NEGATIVE_INFINITY; } else { double d;
/* 160 */           if (value.equals("NaN")) {
/* 161 */             d = NaN.0D;
/*     */           } else
...
/*     */     } catch (NumberFormatException ex) { float f;
/* 175 */       if ((value.equals("INF")) || (value.toLowerCase().equals("infinity"))) {
/* 176 */         f = Float.POSITIVE_INFINITY; } else { float f;
/* 177 */         if ((value.equals("-INF")) || (value.toLowerCase().equals("-infinity")))
/*     */         {
/* 179 */           f = Float.NEGATIVE_INFINITY; } else { float f;
...
/*     */     try
/*     */     {
/* 268 */       return parseInt(this.pp.nextText());
/*     */     }
/*     */     catch (NumberFormatException ex) {
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/xmlpull/v1/wrapper/classic/StaticXmlPullParserWrapper.class
