...
/*     */   }
/*     */   
/*  60 */   public XmlElement getTarget() { return this.target; }
/*     */   
...
/*     */         }
/*  94 */         if (!(currentAdap.target instanceof XmlElementAdapter)) break;
...
/*     */       try
/*     */       {
/* 102 */         currentAdap.topAdapter = ((XmlElementAdapter)adapterClass.getConstructor(new Class[] { XmlElement.class }).newInstance(new Object[] { topAdapter }));
/*     */         
/*     */ 
...
/*     */     try
/*     */     {
/* 113 */       return (XmlElementAdapter)adapterClass.getConstructor(new Class[] { XmlElement.class }).newInstance(new Object[] { el });
/*     */ 
/*     */     }
/*     */     catch (Exception e)
/*     */     {
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/xmlpull/v1/builder/adapter/XmlElementAdapter.class
