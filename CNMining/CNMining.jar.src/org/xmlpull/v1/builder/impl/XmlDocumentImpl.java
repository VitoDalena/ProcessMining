...
/*  33 */     if (pos >= 0) {
/*  34 */       cloned.root = ((XmlElement)cloned.children.get(pos));
/*  35 */       cloned.root.setParent(cloned);
/*     */     }
/*  37 */     return cloned;
/*     */   }
/*     */   
...
/*     */     {
/*  48 */       Object member = list.get(i);
/*     */       Object newMember;
/*  50 */       Object newMember; if ((member instanceof XmlElement)) {
...
/* 132 */         return XmlDocumentImpl.this.children.iterator();
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/* 155 */     rootElement.setParent(this);
/*     */   }
/*     */   
...
/*     */   {
/* 222 */     XmlComment comment = new XmlCommentImpl(this, content);
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/xmlpull/v1/builder/impl/XmlDocumentImpl.class
