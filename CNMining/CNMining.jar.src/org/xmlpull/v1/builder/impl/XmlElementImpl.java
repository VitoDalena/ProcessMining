...
/*     */     {
/*  77 */       Object member = list.get(i);
/*     */       Object newMember;
/*  79 */       Object newMember; if (((member instanceof XmlNamespace)) || ((member instanceof String)))
/*     */       {
/*  81 */         newMember = member; } else { Object newMember;
/*  82 */         if ((member instanceof XmlElement))
/*     */         {
/*     */ 
/*  85 */           XmlElement el = (XmlElement)member;
/*  86 */           newMember = el.clone(); } else { Object newMember;
/*  87 */           if ((member instanceof XmlAttribute)) {
...
/*     */   {
/* 130 */     XmlContainer root = this;
/*     */     
/* 132 */     while ((root instanceof XmlElement))
/*     */     {
/*     */ 
/* 135 */       XmlElement el = (XmlElement)root;
/* 136 */       if (el.getParent() == null) break;
/* 137 */       root = el.getParent();
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     {
/* 328 */       XmlAttribute a = (XmlAttribute)this.attrs.get(i);
...
/*     */       {
/* 415 */         XmlNamespace n = (XmlNamespace)this.nsList.get(i);
...
/*     */       {
/* 436 */         XmlNamespace n = (XmlNamespace)this.nsList.get(i);
...
/* 544 */     return addElement(null, name);
/*     */   }
/*     */   
...
/* 560 */         return new XmlElementImpl.RequiredElementContentIterator(XmlElementImpl.this.children.iterator());
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/* 590 */         buf.append(child.toString());
/* 591 */       } else if ((child instanceof XmlCharacters)) {
/* 592 */         buf.append(((XmlCharacters)child).getText());
/*     */       } else {
...
/* 618 */         if ((child instanceof XmlElement)) {
/* 619 */           count++;
/* 620 */           if (count == position) {
...
/*     */   
/*     */ 
/* 645 */   public XmlElement element(XmlNamespace n, String name) { return element(n, name, false); }
/*     */   
...
/*     */   {
/* 661 */     new Iterable() { private final XmlNamespace val$n;
/*     */       
/* 663 */       public Iterator iterator() { return new XmlElementImpl.ElementsSimpleIterator(XmlElementImpl.this, this.val$n, this.val$name, XmlElementImpl.this.children()); }
/*     */     };
/*     */   }
/*     */   
...
/* 890 */           this.currentEl = ((XmlElement)child);
/* 891 */           break; }
...
/*     */           }
/*     */         }
/* 898 */         else if ((child instanceof XmlCharacters)) {
...
/* 935 */     EmptyIterator(XmlElementImpl.1 x0) { this(); }
/*     */     
/* 937 */     public boolean hasNext() { return false; }
/*     */     
/*     */     public Object next()
/*     */     {
...
/*     */ 
/*     */ 
/* 946 */     public void remove() { throw new XmlBuilderException("this iterator has no content and remove() is not allowed"); }
/*     */     
/*     */     private EmptyIterator() {}
/*     */   }
/*     */   
/* 951 */   private static final Iterator EMPTY_ITERATOR = new EmptyIterator(null);
/*     */   
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/xmlpull/v1/builder/impl/XmlElementImpl.class
