...
/*     */     throws XmlPullParserException, IOException
/*     */   {
/* 105 */     BuildProcess process = new BuildProcess(null);
/* 106 */     return process.parseSubTree(pp, docFactory); }
/*     */   
/*     */   static class BuildProcess { private XmlPullParser pp;
/* 109 */     BuildProcess(DOM2XmlPullBuilder.1 x0) { this(); }
/*     */     
/*     */     private Document docFactory;
/* 112 */     private boolean scanNamespaces = true;
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 193 */           declareOneNamespace(pp, i, parent);
/*     */         }
/*     */       } else {
/* 196 */         for (int i = pp.getNamespaceCount(pp.getDepth() - 1); 
/* 197 */             i < pp.getNamespaceCount(pp.getDepth()); 
/* 198 */             i++)
/*     */         {
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/xmlpull/v1/dom2_builder/DOM2XmlPullBuilder.class
