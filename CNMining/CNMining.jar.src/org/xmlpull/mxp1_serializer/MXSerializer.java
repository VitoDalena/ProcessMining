...
/*      */ 
/*      */ 
/*   86 */   protected static final String[] precomputedPrefixes = new String[32];
/*   87 */   static { for (int i = 0; i < precomputedPrefixes.length; i++)
/*      */     {
/*   89 */       precomputedPrefixes[i] = ("n" + i).intern();
/*      */     }
/*      */   }
/*      */   
/*   93 */   private boolean checkNamesInterned = false;
/*      */   protected int offsetNewLine;
/*      */   
/*   96 */   private void checkInterning(String name) { if ((this.namesInterned) && (name != name.intern())) {
...
/*      */   {
/*  263 */     if (!this.doIndent) return;
/*  264 */     int maxIndent = 65;
/*  265 */     int bufSize = 0;
...
/*      */     
/*      */ 
/*  414 */     this.finished = (this.pastRoot = this.startTagIncomplete = 1);
/*  415 */     this.out.flush();
/*      */   }
/*      */   
...
/*      */   {
/*  510 */     this.autoDeclaredPrefixes += 1;
/*      */     
...
/*  552 */       closeStartTag();
/*      */     }
/*  554 */     this.seenBracket = (this.seenBracketBracket = 0);
/*  555 */     this.depth += 1;
...
/*  591 */                 if ((n != uri) && (!n.equals(uri))) break;
/*  592 */                 this.namespaceEnd -= 1;
/*  593 */                 prefix = elPfx;
/*  594 */                 break;
/*      */               }
/*      */             }
...
/*      */             {
/*  619 */               setPrefix("", "");
/*  620 */               break; } if (uri.length() <= 0) break;
...
/*  683 */       this.seenBracket = (this.seenBracketBracket = 0);
/*      */     }
...
/*      */     throws IOException
/*      */   {
/*  734 */     this.seenBracket = (this.seenBracketBracket = 0);
...
/*  993 */           this.seenBracketBracket = (this.seenBracket = 0);
/*      */         }
/*      */       }
/*      */     }
/*      */     
...
/* 1076 */           this.seenBracketBracket = (this.seenBracket = 0);
/*      */         }
/*      */       }
/*      */     }
/*      */     
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/xmlpull/mxp1_serializer/MXSerializer.class
