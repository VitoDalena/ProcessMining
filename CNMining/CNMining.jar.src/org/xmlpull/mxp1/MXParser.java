...
/*      */   
/*      */ 
/*  340 */   protected char[] buf = new char[Runtime.getRuntime().freeMemory() > 1000000L ? ' ' : 'Ā'];
/*      */   
...
/*  713 */       if (this.usePC) {
/*  714 */         for (int i = this.pcStart; i < this.pcEnd; i++)
/*      */         {
/*  716 */           if (!isS(this.pc[i])) return false;
/*      */         }
/*  718 */         return true;
/*      */       }
...
/* 1139 */         ch = '<'; } else { char ch;
/* 1140 */         if (this.seenAmpersand) {
...
/*      */     {
/* 1738 */       ch = more();
/* 1739 */       if (!isNameChar(ch)) break;
/* 1740 */       if ((ch == ':') && (this.processNamespaces)) {
...
/* 1794 */           ch = more();
/* 1795 */           if (ch == '>') break label568; throw new XmlPullParserException("expected > to end empty tag not " + printable(ch), this, null);
/*      */         }
/*      */         
/* 1798 */         if (!isNameStartChar(ch)) break;
...
/*      */ 
/*      */ 
/* 1830 */       for (int i = 0; i < this.attributeCount; i++)
/*      */       {
...
/*      */ 
/*      */ 
/* 1851 */       for (int i = 1; i < this.attributeCount; i++)
/*      */       {
...
/*      */       }
/*      */       
/* 2147 */       this.attributeCount += 1;
/*      */     }
/* 2149 */     this.posStart = (prevPosStart - this.bufAbsoluteStart);
/* 2150 */     return ch;
/*      */   }
/*      */   
/* 2153 */   protected char[] charRefOneCharBuf = new char[1];
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/* 2172 */           ch = more();
/* 2173 */           if ((ch >= '0') && (ch <= '9')) {
/* 2174 */             charRef = (char)(charRef * '\020' + (ch - '0'));
/* 2175 */           } else if ((ch >= 'a') && (ch <= 'f')) {
/* 2176 */             charRef = (char)(charRef * '\020' + (ch - 'W'));
/* 2177 */           } else { if ((ch < 'A') || (ch > 'F')) break;
/* 2178 */             charRef = (char)(charRef * '\020' + (ch - '7')); } }
/* 2179 */         if (ch != ';')
/*      */         {
/*      */ 
...
/*      */       label130:
/* 2287 */       for (int i = this.entityEnd - 1; i >= 0; i--)
/*      */       {
...
/* 2770 */       if ((ch == '>') && (bracketLevel == 0)) break;
/* 2771 */       if (normalizeIgnorableWS) {
/* 2772 */         if (ch == '\r') {
...
/*      */         }
/* 3017 */         expectedTagStack.append(" ");
/* 3018 */         for (int i = this.depth; i > 0; i--)
/*      */         {
...
/* 3024 */         for (int i = this.depth; i > 0; i--)
/*      */         {
...
/*      */ 
/*      */ 
/* 3129 */   protected static boolean[] lookupNameStartChar = new boolean['Ѐ'];
/* 3130 */   protected static boolean[] lookupNameChar = new boolean['Ѐ'];
/*      */   
/*      */ 
/*      */ 
/* 3134 */   private static final void setName(char ch) { lookupNameChar[ch] = true; }
/*      */   
/*      */   private static final void setNameStart(char ch) {
/* 3137 */     lookupNameStartChar[ch] = true;setName(ch);
/*      */   }
/*      */   
/* 3140 */   static { setNameStart(':');
/* 3141 */     for (char ch = 'A'; ch <= 'Z'; ch = (char)(ch + '\001')) setNameStart(ch);
/* 3142 */     setNameStart('_');
/* 3143 */     for (char ch = 'a'; ch <= 'z'; ch = (char)(ch + '\001')) setNameStart(ch);
/* 3144 */     for (char ch = 'À'; ch <= '˿'; ch = (char)(ch + '\001')) setNameStart(ch);
/* 3145 */     for (char ch = 'Ͱ'; ch <= 'ͽ'; ch = (char)(ch + '\001')) setNameStart(ch);
/* 3146 */     for (char ch = 'Ϳ'; ch < 'Ѐ'; ch = (char)(ch + '\001')) { setNameStart(ch);
/*      */     }
/* 3148 */     setName('-');
/* 3149 */     setName('.');
/* 3150 */     for (char ch = '0'; ch <= '9'; ch = (char)(ch + '\001')) setName(ch);
/* 3151 */     setName('·');
/* 3152 */     for (char ch = '̀'; ch <= 'ͯ'; ch = (char)(ch + '\001')) setName(ch);
/*      */   }
/*      */   
/*      */   protected boolean isNameStartChar(char ch)
/*      */   {
/* 3157 */     return ((ch < 'Ѐ') && (lookupNameStartChar[ch] != 0)) || ((ch >= 'Ѐ') && (ch <= '‧')) || ((ch >= '‪') && (ch <= '↏')) || ((ch >= '⠀') && (ch <= 65519));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 3191 */     return ((ch < 'Ѐ') && (lookupNameChar[ch] != 0)) || ((ch >= 'Ѐ') && (ch <= '‧')) || ((ch >= '‪') && (ch <= '↏')) || ((ch >= '⠀') && (ch <= 65519));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/xmlpull/mxp1/MXParser.class
