...
/* 300 */     Rectangle2D bounds = RectangleAnchor.createRectangle(d2, x, y, anchor);
/*     */     
/* 302 */     double xx = bounds.getX();
/* 303 */     double yy = bounds.getY();
/*     */     
/* 305 */     if (this.shadowPaint != null) {
/* 306 */       Rectangle2D shadow = new Rectangle2D.Double(xx + this.shadowXOffset, yy + this.shadowYOffset, bounds.getWidth(), bounds.getHeight());
/*     */       
/*     */ 
...
/*     */     }
/*     */     
/* 323 */     this.textBlock.draw(g2, (float)(xx + this.interiorGap.calculateLeftInset(w)), (float)(yy + this.interiorGap.calculateTopInset(h)), TextBlockAnchor.TOP_LEFT);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 395 */     result = 29 * result + (this.outlineStroke != null ? this.outlineStroke.hashCode() : 0);
/*     */     
/* 397 */     result = 29 * result + (this.interiorGap != null ? this.interiorGap.hashCode() : 0);
/*     */     
/* 399 */     result = 29 * result + (this.backgroundPaint != null ? this.backgroundPaint.hashCode() : 0);
/*     */     
/* 401 */     result = 29 * result + (this.shadowPaint != null ? this.shadowPaint.hashCode() : 0);
/*     */     
/* 403 */     long temp = this.shadowXOffset != 0.0D ? Double.doubleToLongBits(this.shadowXOffset) : 0L;
/*     */     
/* 405 */     result = 29 * result + (int)(temp ^ temp >>> 32);
/* 406 */     temp = this.shadowYOffset != 0.0D ? Double.doubleToLongBits(this.shadowYOffset) : 0L;
/*     */     
/* 408 */     result = 29 * result + (int)(temp ^ temp >>> 32);
/* 409 */     result = 29 * result + (this.textBlock != null ? this.textBlock.hashCode() : 0);
/*     */     
/* 411 */     return result;
/*     */   }
/*     */   
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/text/TextBox.class
