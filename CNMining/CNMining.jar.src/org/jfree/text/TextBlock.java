...
/* 198 */     float[] offsets = calculateOffsets(anchor, d.getWidth(), d.getHeight());
/*     */     
/*     */ 
/* 201 */     Rectangle2D bounds = new Rectangle2D.Double(anchorX + offsets[0], anchorY + offsets[1], d.getWidth(), d.getHeight());
/*     */     
/*     */ 
/*     */ 
/* 205 */     Shape rotatedBounds = ShapeUtilities.rotateShape(bounds, angle, rotateX, rotateY);
/*     */     
/*     */ 
...
/*     */   {
/* 222 */     draw(g2, x, y, anchor, 0.0F, 0.0F, 0.0D);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 245 */     float[] offsets = calculateOffsets(anchor, d.getWidth(), d.getHeight());
/*     */     
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/text/TextBlock.class
