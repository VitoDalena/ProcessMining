...
/*      */         Component c0;
/*  222 */         Component c1; Component c2; Component c3; Component c4; switch (format) {
/*      */         case 1: 
/*  224 */           c0 = parent.getComponent(componentIndex);
/*  225 */           updateC(rowIndex, c0.getPreferredSize());
/*  226 */           componentIndex += 1;
/*  227 */           break;
/*      */         case 2: 
...
/*  291 */           Component c5 = parent.getComponent(componentIndex + 5);
...
/*      */         Component c0;
/*      */         Component c1;
/*  339 */         Component c2; Component c3; Component c4; switch (format) {
/*      */         case 1: 
...
/*  411 */           Component c5 = parent.getComponent(componentIndex + 5);
...
/*  525 */           Component c5 = parent.getComponent(componentIndex + 5);
...
/*  557 */         int format = this.rowFormats[(rowIndex % this.rowFormats.length)];
/*      */         Component c1;
/*      */         Component c2;
/*  560 */         Component c3; Component c4; switch (format) {
/*      */         case 1: 
/*  562 */           c0 = parent.getComponent(componentIndex);
/*  563 */           c0.setBounds(rowX[0], rowY, w0to5, c0.getPreferredSize().height);
/*      */           
/*  565 */           componentIndex += 1;
/*  566 */           break;
/*      */         case 2: 
/*  568 */           c0 = parent.getComponent(componentIndex);
/*  569 */           c0.setBounds(rowX[0], rowY + (this.rowHeights[rowIndex] - c0.getPreferredSize().height) / 2, this.columnWidths[0], c0.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  576 */           c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex] - c1.getPreferredSize().height) / 2, w1to5, c1.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  586 */           c0.setBounds(rowX[0], rowY + (this.rowHeights[rowIndex] - c0.getPreferredSize().height) / 2, this.columnWidths[0], c0.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  593 */           c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex] - c1.getPreferredSize().height) / 2, w1to4, c1.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  600 */           c2.setBounds(rowX[5], rowY + (this.rowHeights[rowIndex] - c2.getPreferredSize().height) / 2, this.columnWidths[5], c2.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  610 */           c0.setBounds(rowX[0], rowY + (this.rowHeights[rowIndex] - c0.getPreferredSize().height) / 2, this.columnWidths[0], c0.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  617 */           c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex] - c1.getPreferredSize().height) / 2, w1to2, c1.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  624 */           c2.setBounds(rowX[3], rowY + (this.rowHeights[rowIndex] - c2.getPreferredSize().height) / 2, this.columnWidths[3], c2.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  631 */           c3.setBounds(rowX[4], rowY + (this.rowHeights[rowIndex] - c3.getPreferredSize().height) / 2, w4to5, c3.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  641 */           c0.setBounds(rowX[0], rowY + (this.rowHeights[rowIndex] - c0.getPreferredSize().height) / 2, this.columnWidths[0], c0.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  648 */           c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex] - c1.getPreferredSize().height) / 2, this.columnWidths[1], c1.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  655 */           c2.setBounds(rowX[2], rowY + (this.rowHeights[rowIndex] - c2.getPreferredSize().height) / 2, this.columnWidths[2], c2.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  662 */           c3.setBounds(rowX[3], rowY + (this.rowHeights[rowIndex] - c3.getPreferredSize().height) / 2, this.columnWidths[3], c3.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  669 */           c4.setBounds(rowX[4], rowY + (this.rowHeights[rowIndex] - c4.getPreferredSize().height) / 2, w4to5, c4.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  679 */           c0.setBounds(rowX[0], rowY + (this.rowHeights[rowIndex] - c0.getPreferredSize().height) / 2, this.columnWidths[0], c0.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  686 */           c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex] - c1.getPreferredSize().height) / 2, w1to2, c1.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  693 */           c2.setBounds(rowX[3], rowY + (this.rowHeights[rowIndex] - c2.getPreferredSize().height) / 2, this.columnWidths[3], c2.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  700 */           c3.setBounds(rowX[4], rowY + (this.rowHeights[rowIndex] - c3.getPreferredSize().height) / 2, this.columnWidths[4], c3.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  707 */           c4.setBounds(rowX[5], rowY + (this.rowHeights[rowIndex] - c4.getPreferredSize().height) / 2, this.columnWidths[5], c4.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  717 */           c0.setBounds(rowX[0], rowY + (this.rowHeights[rowIndex] - c0.getPreferredSize().height) / 2, this.columnWidths[0], c0.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  724 */           c1.setBounds(rowX[1], rowY + (this.rowHeights[rowIndex] - c1.getPreferredSize().height) / 2, this.columnWidths[1], c1.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  731 */           c2.setBounds(rowX[2], rowY + (this.rowHeights[rowIndex] - c2.getPreferredSize().height) / 2, this.columnWidths[2], c2.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  738 */           c3.setBounds(rowX[3], rowY + (this.rowHeights[rowIndex] - c3.getPreferredSize().height) / 2, this.columnWidths[3], c3.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  745 */           c4.setBounds(rowX[4], rowY + (this.rowHeights[rowIndex] - c4.getPreferredSize().height) / 2, this.columnWidths[4], c4.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  751 */           Component c5 = parent.getComponent(componentIndex + 5);
/*  752 */           c5.setBounds(rowX[5], rowY + (this.rowHeights[rowIndex] - c5.getPreferredSize().height) / 2, this.columnWidths[5], c5.getPreferredSize().height);
/*      */           
/*      */ 
/*      */ 
/*      */ 
...
/*  963 */         this.columnWidths[4] += mismatch;
/*  964 */         rightWidth += mismatch;
/*      */       }
/*      */       else {
/*  967 */         int mismatch = rightWidth - leftWidth;
/*  968 */         this.columnWidths[1] += mismatch;
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/layout/FormatLayout.class
