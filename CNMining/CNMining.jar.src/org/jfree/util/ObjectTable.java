...
/* 199 */     if (current == null)
/*     */     {
/* 201 */       Object[] enlarged = new Object[Math.max(column + 1, this.columnIncrement)];
/*     */       
...
/*     */       {
/* 321 */         if (!ObjectUtilities.equal(getObject(r, c), ot.getObject(r, c)))
/*     */         {
/*     */ 
/* 324 */           return false;
/*     */         }
...
/*     */     else
/*     */     {
/* 481 */       this.data[newRow] = ((Object[])(Object[])oldRowStorage.clone());
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/util/ObjectTable.class
