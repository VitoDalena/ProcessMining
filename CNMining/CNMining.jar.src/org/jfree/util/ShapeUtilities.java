...
/*     */     }
/* 345 */     Point2D anchorPoint = RectangleAnchor.coordinates(shape.getBounds2D(), anchor);
/*     */     
/* 347 */     AffineTransform transform = AffineTransform.getTranslateInstance(locationX - anchorPoint.getX(), locationY - anchorPoint.getY());
/*     */     
...
/*     */     
/* 370 */     Shape result = rotate.createTransformedShape(base);
/* 371 */     return result;
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 578 */     return (x >= x0) && (y >= y0) && (x + w <= x0 + rect1.getWidth()) && (y + h <= y0 + rect1.getHeight());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 604 */     return (x + width >= x0) && (y + height >= y0) && (x <= x0 + rect1.getWidth()) && (y <= y0 + rect1.getHeight());
/*     */   }
/*     */ }


/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/util/ShapeUtilities.class
