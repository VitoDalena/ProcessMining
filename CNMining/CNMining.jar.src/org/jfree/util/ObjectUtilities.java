...
/*     */   {
/* 116 */     classLoaderSource = classLoaderSource;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 212 */     Collection result = (Collection)clone(collection);
/*     */     
/* 214 */     result.clear();
...
/*     */     try
/*     */     {
/* 448 */       ClassLoader loader = getClassLoader(ObjectUtilities.class);
/* 449 */       if (loader != null) {
/*     */         try {
...
/*     */     try
/*     */     {
/* 469 */       String version = System.getProperty("java.vm.specification.version");
/*     */       
/*     */ 
/* 472 */       if (version == null) {
/* 473 */         return false;
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/util/ObjectUtilities.class
