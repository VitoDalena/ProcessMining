...
/*     */ 
/*     */ 
/* 115 */       for (int i = nextChar; i < nChars; i++)
/*     */       {
/* 117 */         c = this.text[i];
/* 118 */         if ((c == '\n') || (c == '\r'))
/*     */         {
...
/* 226 */       while ((pos > end) && ((this.text[(pos - 1)] == '\n') || (this.text[(pos - 1)] == '\r'))) { pos--;
/*     */       }
/*     */     }
/*     */     
/*     */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/util/LineBreakIterator.class
