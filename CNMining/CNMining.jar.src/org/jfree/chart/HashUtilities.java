...
/* 262 */       if (size > 1) {
/* 263 */         result = hashCode(result, list.getBoolean(size - 1));
/*     */         
/* 265 */         if (size > 2) {
/* 266 */           result = hashCode(result, list.getBoolean(size / 2));
/*     */         }
/*     */       }
/*     */     }
/*     */     
...
/* 299 */       if (size > 1) {
/* 300 */         result = hashCode(result, list.getPaint(size - 1));
/*     */         
/* 302 */         if (size > 2) {
/* 303 */           result = hashCode(result, list.getPaint(size / 2));
/*     */         }
/*     */       }
/*     */     }
/*     */     
...
/* 336 */       if (size > 1) {
/* 337 */         result = hashCode(result, list.getStroke(size - 1));
/*     */         
/* 339 */         if (size > 2) {
/* 340 */           result = hashCode(result, list.getStroke(size / 2));
/*     */         }
/*     */       }
/*     */     }
/*     */     
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/chart/HashUtilities.class
