...
/* 139 */       LineMetrics metrics = this.font.getLineMetrics("123g", g2.getFontRenderContext());
/*     */       
/*     */ 
...
/*     */     }
/* 167 */     LineMetrics metrics = font.getLineMetrics(text, g2.getFontRenderContext());
/*     */     
/*     */ 
/* 170 */     g2.drawString(text, (float)x, (float)(bounds.getMaxY() - this.bottomInnerGap - metrics.getDescent()));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 192 */       double start = Math.max(marker.getStartValue(), this.axis.getRange().getLowerBound());
/*     */       
/*     */ 
/* 195 */       double end = Math.min(marker.getEndValue(), this.axis.getRange().getUpperBound());
/*     */       
/*     */ 
...
/* 210 */       g2.setComposite(AlphaComposite.getInstance(3, marker.getAlpha()));
/*     */       
/*     */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/chart/axis/MarkerAxisBand.class
