...
/* 250 */       ReaderHelper rh = new ReaderHelper(new BufferedReader(new InputStreamReader(in, "ISO-8859-1")));
/*     */       
/*     */       try
/*     */       {
...
/*     */       }
/*     */       
/* 281 */       this.optionalModules = ((ModuleInfo[])optionalModules.toArray(new ModuleInfo[optionalModules.size()]));
/*     */       
/*     */ 
/* 284 */       this.requiredModules = ((ModuleInfo[])dependendModules.toArray(new ModuleInfo[dependendModules.size()]));
/*     */ 
/*     */     }
...
/*     */   {
/* 703 */     InputStream in = ObjectUtilities.getResourceRelativeAsStream("configuration.properties", getClass());
/*     */     
/* 705 */     if (in == null)
/*     */     {
/* 707 */       return;
...
/*     */     try
/*     */     {
/* 711 */       subSystem.getPackageManager().getPackageConfiguration().load(in); return;
/*     */     }
/*     */     finally
/*     */     {
/*     */       try
...
/*     */     try
/*     */     {
/* 739 */       ModuleInitializer mi = (ModuleInitializer)ObjectUtilities.loadAndInstantiate(classname, AbstractModule.class, ModuleInitializer.class);
/*     */       
/* 741 */       if (mi == null)
/*     */       {
...
/*     */     try
/*     */     {
/* 769 */       ModuleInitializer mi = (ModuleInitializer)ObjectUtilities.loadAndInstantiate(classname, context, ModuleInitializer.class);
/*     */       
/* 771 */       if (mi == null)
/*     */       {
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/base/modules/AbstractModule.class
