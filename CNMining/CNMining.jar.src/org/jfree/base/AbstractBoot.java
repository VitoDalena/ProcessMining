...
/*     */     }
/*     */     try {
/* 238 */       Class c = ObjectUtilities.getClassLoader(getClass()).loadClass(classname);
/*     */       
...
/*     */   {
/* 269 */     return createDefaultHierarchicalConfiguration(staticConfig, userConfig, addSysProps, PropertyFileConfiguration.class);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 295 */       globalConfig.insertConfiguration(getPackageManager().getPackageConfiguration());
/*     */     }
/*     */     
/* 298 */     if (userConfig != null) { String userConfigStripped;
...
/*     */       }
/*     */       try {
/* 307 */         Enumeration userConfigs = ObjectUtilities.getClassLoader(getClass()).getResources(userConfigStripped);
/*     */         
...
/* 326 */           PropertyFileConfiguration baseProperty = (PropertyFileConfiguration)configs.get(i);
/*     */           
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/base/AbstractBoot.class
