...
/*  87 */   protected static ResourceBundle localizationResources = ResourceBundleWrapper.getBundle("org.jfree.ui.LocalizationBundle");
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 118 */     panel.setBorder(new TitledBorder(localizationResources.getString("Insets")));
/*     */     
/*     */ 
/*     */ 
...
/*     */   {
/* 179 */     return new Insets(Math.abs(stringToInt(this.topValueEditor.getText())), Math.abs(stringToInt(this.leftValueEditor.getText())), Math.abs(stringToInt(this.bottomValueEditor.getText())), Math.abs(stringToInt(this.rightValueEditor.getText())));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/ui/InsetsChooserPanel.class
