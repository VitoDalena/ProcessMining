...
/*  96 */     if (isRaisedView) {
/*  97 */       if (isPressedView) {
/*  98 */         init(UIManager.getColor("controlLtHighlight"), UIManager.getColor("controlDkShadow"), UIManager.getColor("controlShadow"), 11, direction);
/*     */ 
/*     */       }
/*     */       else
/*     */       {
/*     */ 
/* 104 */         init(UIManager.getColor("controlHighlight"), UIManager.getColor("controlShadow"), UIManager.getColor("control"), 11, direction);
/*     */ 
/*     */       }
/*     */       
/*     */ 
...
/* 112 */       init(UIManager.getColor("controlDkShadow"), UIManager.getColor("controlLtHighlight"), UIManager.getColor("controlShadow"), 11, direction);
/*     */ 
/*     */     }
/*     */     else
/*     */     {
/*     */ 
/* 118 */       init(UIManager.getColor("controlShadow"), UIManager.getColor("controlHighlight"), UIManager.getColor("control"), 11, direction);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 156 */     case 1:  drawDownArrow(g, x, y); break;
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/ui/BevelArrowIcon.class
