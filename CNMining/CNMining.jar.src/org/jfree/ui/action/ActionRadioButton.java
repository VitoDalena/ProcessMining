...
/*     */         {
/*  96 */           ActionRadioButton.this.setText((String)ActionRadioButton.this.getAction().getValue("Name"));
/*     */ 
/*     */         }
/*  99 */         else if (event.getPropertyName().equals("ShortDescription"))
/*     */         {
/* 101 */           ActionRadioButton.this.setToolTipText((String)ActionRadioButton.this.getAction().getValue("ShortDescription"));
/*     */         }
/*     */         
/*     */ 
...
/* 109 */           if (oldVal != null)
/*     */           {
/* 111 */             ActionRadioButton.this.unregisterKeyboardAction(oldVal);
/*     */           }
/*     */           
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/ui/action/ActionRadioButton.class
