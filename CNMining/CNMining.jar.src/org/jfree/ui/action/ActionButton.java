...
/* 101 */           ActionButton.this.setText((String)ActionButton.this.getAction().getValue("Name"));
/*     */ 
/*     */         }
/* 104 */         else if (event.getPropertyName().equals("ShortDescription")) {
/* 105 */           ActionButton.this.setToolTipText((String)ActionButton.this.getAction().getValue("ShortDescription"));
/*     */         }
/*     */         
/*     */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/ui/action/ActionButton.class
