...
/*     */   public int hashCode()
/*     */   {
/* 220 */     int result = this.unitType != null ? this.unitType.hashCode() : 0;
...
/*     */   {
/* 239 */     return "RectangleInsets[t=" + this.top + ",l=" + this.left + ",b=" + this.bottom + ",r=" + this.right + "]";
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/* 327 */     return new Rectangle2D.Double(base.getX() + leftMargin, base.getY() + topMargin, base.getWidth() - leftMargin - rightMargin, base.getHeight() - topMargin - bottomMargin);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/* 373 */     return new Rectangle2D.Double(base.getX() - leftMargin, base.getY() - topMargin, base.getWidth() + leftMargin + rightMargin, base.getHeight() + topMargin + bottomMargin);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 531 */     return height - calculateTopInset(height) - calculateBottomInset(height);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 543 */     return height + calculateTopOutset(height) + calculateBottomOutset(height);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/org/jfree/ui/RectangleInsets.class
