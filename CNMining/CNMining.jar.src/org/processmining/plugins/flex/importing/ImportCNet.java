 ...
 *
 */
@Plugin(name = "Open CNet file", parameterLabels = { "Filename" }, returnLabels = { "Causal net", "Start task node", "End task node" }, returnTypes = {
		Flex.class, StartTaskNodesSet.class, EndTaskNodesSet.class })
@UIImportPlugin(description = "Causal Net files", extensions = { "cnet" })
public class ImportCNet extends AbstractImportPlugin {
	...
	protected Object importFromStream(PluginContext context, InputStream input, String filename, long fileSizeInBytes)
		...
		return new Object[] { flex, startTaskNodesSet, endTaskNodesSet };
	}
