 ...
 * 
 */
@Plugin(name = "Export as Causal Net (.cnet)", returnLabels = {}, returnTypes = {}, parameterLabels = { "Causal net", "File" }, userAccessible = true)
@UIExportPlugin(description = "Export as Causal Net (.cnet)", extension = "cnet")
public class ExportCNet {
	@PluginVariant(variantLabel = "Export as Causal Net (.cnet)", requiredParameterLabels = { 0, 1 })
