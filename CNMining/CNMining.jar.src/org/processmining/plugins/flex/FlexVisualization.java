 ...
 * @version Nov 19, 2009
 */
@Plugin(name = "Visualize Causal Net", returnLabels = { "Visualized Causal Net" }, returnTypes = { JComponent.class }, parameterLabels = {
		"Causal Net", "Start Task Node", "End Task Node" }, userAccessible = false)
@Visualizer
