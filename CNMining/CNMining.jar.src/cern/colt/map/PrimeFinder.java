...
/*     */   static
/*     */   {
/* 128 */     Arrays.sort(primeCapacities);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 144 */     int i = Integer.parseInt(paramArrayOfString[0]);
/* 145 */     int j = Integer.parseInt(paramArrayOfString[1]);
/*     */     
/* 147 */     statistics(i, j);
/*     */   }
/*     */   
...
/*     */   {
/* 155 */     int i = Arrays.binarySearch(primeCapacities, paramInt);
/*     */     
/* 157 */     if (i < 0)
/*     */     {
/* 159 */       i = -i - 1;
/*     */     }
/* 161 */     return primeCapacities[i];
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 168 */     for (int i = 0; i < primeCapacities.length - 1; i++) {
/* 169 */       if (primeCapacities[i] >= primeCapacities[(i + 1)]) { throw new RuntimeException("primes are unsorted or contain duplicates; detected at " + i + "@" + primeCapacities[i]);
/*     */       }
/*     */     }
/* 172 */     double d1 = 0.0D;
/* 173 */     double d2 = -1.0D;
/*     */     
/* 175 */     for (int j = paramInt1; j <= paramInt2; j++) {
/* 176 */       int k = nextPrime(j);
/*     */       
/* 178 */       double d3 = (k - j) / j;
/*     */       
/* 180 */       if (d3 > d2) {
/* 181 */         d2 = d3;
/* 182 */         System.out.println("new maxdev @" + j + "@dev=" + d2);
/*     */       }
/*     */       
/* 185 */       d1 += d3;
/*     */     }
/* 187 */     long l = 1L + paramInt2 - paramInt1;
/*     */     
/* 189 */     double d4 = d1 / l;
/* 190 */     System.out.println("Statistics for [" + paramInt1 + "," + paramInt2 + "] are as follows");
/* 191 */     System.out.println("meanDeviation = " + (float)d4 * 100.0F + " %");
/* 192 */     System.out.println("maxDeviation = " + (float)d2 * 100.0F + " %");
/*     */   }
/*     */ }


/* Location:              /home/menick/Scrivania/ProcessMining/CNMining/CNMining.jar!/cern/colt/map/PrimeFinder.class
