...
import org.processmining.framework.util.ui.widgets.ProMJGraph;
...
public class CNMiningDiagram {
	...
	public void visualize(){
	    ...
	    ProMJGraphPanel mainPanel = ProMJGraphVisualizer.instance().visualizeGraph(pluginContext, flexDiagram);
